...
$form['form-1'] = array(
	...
	'cfg' => array(
		'charset' => 'utf-8',
		'subject' => 'консультація по телефону',
		'title' => 'клієнту треба консультація',
		'ajax' => true,
		'validate' => true,
    'from_email' => 'info@terrafarm.ho.ua',
    'from_name' => 'terrafarm',
    'to_email' => 'sasha-3250@bigmir.net, alejandr000091@gmail.com',
    'to_name' => 'sasha-3250, alejandr000091',
		'geoip' => true,
		'referer' => true,
		'type' => 'html',
		'tpl' => true,
...
$form['form-2'] = array(
	'fields' => array(
		'name' => array(
			...
			'messages' => array(
				'preg' => 'Поле [ %1$s ] містить помилку',
				'minlength' => 'Мінімальна кількість символів в полі [ %1$s ] меньше мінімальної - %2$s',
				'maxlength' => 'Максимальна кількість символів в полі [ %1$s ] перебільшує максимальну - %2$s',
			)
		),
		'tell' => array(
			'title' => 'Телефон',
			...
			'messages' => array(
				'preg' => 'Поле [ %1$s ] містить помилку, формат запису +380...',
				'minlength' => 'Мінімальна кількість символів в полі [ %1$s ] меньше мінімальної - %2$s',
			)
		),
		'e-mail' => array(
			...
			'messages' => array(
				'preg' => 'Поле [ %1$s ] містить помилку, формат запису login@domen.com',
				'minlength' => 'Мінімальна кількість символів в полі [ %1$s ] меньше мінімальної - %2$s',
			)
			),
		...
		'text' => array(
			...
			'messages' => array(
				'minlength' => '[ %1$s ] необхідно вибрати спосіб комунікації телефон/E-mail',
			)
		),
	),
	'cfg' => array(
		'charset' => 'utf-8',
    'subject' => 'запит з сайту форма зз',
    'title' => 'запит з сайту форма зз',
		'ajax' => true,
		'validate' => true,
    ...
    'to_name' => 'sasha-3250, alejandr000091',
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Повідомлення відправлено - OK',
		'fuck' => 'Повідомлення не відправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
	)
...
$form['form-4'] = array(
  ...
  'cfg' => array(
    ...
    'ajax' => true,
    'validate' => true,
    'from_email' => 'sales@oblender.ho.ua',
    'from_name' => 'oblender',
    'to_email' => 'sasha-3250@bigmir.net, alejandr000091@gmail.com',
    'to_name' => 'sasha-3250, alejandr000091',
    'geoip' => true,
